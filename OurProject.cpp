...
private:
    ...
    void flightSchedule() {
        ...
        cout << "\t\t\t\t\t| 01  |   PK001      |  Lahore           |     Karachi          |   150$      |\n";
	    cout << "\t\t\t\t\t| 02  |   PK002      |  Peshawar         |     Lahore           |   200$      |\n";
	    cout << "\t\t\t\t\t| 03  |   PK003      |  Lahore           |     Peshawar         |    75$      |\n";
	    cout << "\t\t\t\t\t| 04  |   PK004      |  Islamabad        |     Karachi          |   100$      |\n";
	    cout << "\t\t\t\t\t| 05  |   PK005      |  Islamabad        |     Quetta           |   175$      |\n";
